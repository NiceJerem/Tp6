...
public class TP7 {
    ...
    public void t2_good() {
        ...
        ItemPage item = gamesPage.openItem(0);
        ...
        cartPage = itemAddedPage.getHeader().openCart();
        cartPage.changeItemQuantity(0, 1); // changer la quantite de notre premier article a 3
        Assert.assertThat(cartPage.getTotalPrice(), Is.is("EUR 197,80"));
    ...
    public void t3() {
        ...
        ItemPage item = gamesPage.openItem(0);
        ItemAddedPage itemAddedPage = item.addToCart();
        consolePage = home.getHeader().openVideoGames("Nintendo Switch");
        gamesPage = consolePage.openGamesCategory();
        item = gamesPage.openItem(3);
        itemAddedPage = item.addToCart();
